...
class TestSOSGameGeneralMode(unittest.TestCase):
    ...
    def test_multiple_sos_single_move(self):
        ...
        self.assertEqual(self.game.current_player, "Blue")  # Blue gets another turn due to SOS
        self.assertEqual(self.game.blue_score, 4)  # Blue should get points for all SOS patterns
